...
#+begin_src python
  ...
  Traceback (most recent call last):
    File "<python-input-2>", line 1, in <module>
      import importme3
    File "/home/aodag/ghq/github.com/aodag/pyconmini-tokai-2025/importme3.py", line 4, in <module>
      raise Exception()
  Exception
  >>> import ximportme3
  >>> ximportme3
  <module 'importme3' from '/home/aodag/ghq/github.com/aodag/pyconmini-tokai-2025/importme3.py'>
#+end_src
...
- ~__next__~ を定義するだけではだめ

** TODO モジュールよ、nextになるのを拒むな
